/// Hi data miners you look very nice today is that a new shirt?
...
// don't know what else to put here so I might add other stuff here or in other parts of my sources code 
// have fun digging threw my teriable code